...
def main():
    ...
    with top_title:
        st.markdown("<h1 class='title-text' style='margin-bottom:0rem; margin-top:3.5rem;'>Dashboard de Coberturas y Métricas</h1>", unsafe_allow_html=True)
        ...
        try:
            ...
            with row2_right:
                with st.container(border=True):
                    ...
                    # Calcular Factor si está %Cambio_prima
                    ...
                    if df_sel.empty:
                        ...
                        # Renombrar variables a etiquetas amigables
